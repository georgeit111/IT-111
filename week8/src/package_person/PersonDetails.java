...
//    this file will have the main method
...
//        System.out.println(secondPerson.creditScore);
        ...
        System.out.println("Preliminary Rate for " +firstPerson.name+ ": " +firstPerson.getRate(monthlyRate)+ " Dollars");
            System.out.println("Adjustments: " +firstPerson.assumeGender(adjustRate) + " Dollars");
            System.out.print("Here is " +firstPerson.name+ "'s total monthly premium: ");
            System.out.println(firstPerson.assumeGender(adjustRate) + firstPerson.getRate(monthlyRate));
            System.out.println();


        secondPerson.display();
        System.out.println("Adjustments: " +secondPerson.assumeGender(adjustRate) + " Dollars");
            ...
            System.out.println(secondPerson.assumeGender(adjustRate) + secondPerson.getRate(monthlyRate));
        System.out.println();


        thirdPerson.display();
        System.out.println("Adjustments: " +thirdPerson.assumeGender(adjustRate) + " Dollars");
        ...
        System.out.println(thirdPerson.assumeGender(adjustRate) + thirdPerson.getRate(monthlyRate));
